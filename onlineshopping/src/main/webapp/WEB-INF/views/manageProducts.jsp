					...
					>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="name" id="name"
									placeholder="Product Name" class="form-control"></sf:input> <em
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<sf:input type="text" path="brand" id="brand"
									placeholder="Brand Name" class="form-control"></sf:input> <em
						...
						<div class="form-group">
							<label class="control-label col-md-4" for="decription">Product
								Description:</label>
							<div class="col-md-8">
								<sf:textarea rows="4" cols="70" path="description" id="description"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<em class="help-block">Quantity Available!</em>
							</div>
